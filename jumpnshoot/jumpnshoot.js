...
$("<style>")
    ...
    .html("@keyframes hit {\
           ...
           @keyframes destroy {\
                ...
                15%   {transform: translateY(-200px) translateX(200px) rotate(520deg); visibility:visible;}\
                99% {transform: translateY(3000px) translateX(300px) rotate(2500deg); visibility:hidden;}\
